...
기본 약관과 개인정보처리방침은 영어로 제공합니다. 기존 한국어 본문을 영어로 바꾸려면 위 두 탭에 각각 `terms.md`와 `privacy.md`의 내용을 붙여 넣고 저장해 주세요.
...
- 계정, 답안, 행동 기록, 접속 로그의 보유 기간과 삭제 절차: DB 백업·로그 보관본까지 포함해 정해야 합니다. CloudWatch 애플리케이션·행동 로그는 자동 만료 없이 보관됩니다. 실제 보유 기간과 삭제 절차는 별도로 정해야 합니다.
