...
class ServerConfig(object):
    ...
    # Google Workspace domains allowed to sign in, comma-separated, or "*" for
    # any Workspace domain. Consumer accounts (Gmail) are never accepted.
    GOOGLE_HOSTED_DOMAIN: str = empty_str_cast(
        config_ini["oauth"].get("GOOGLE_HOSTED_DOMAIN", ""), default="*"
    )
