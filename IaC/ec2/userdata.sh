...
env_values = {
    ...
    "MAX_UPLOAD_CONTENT_LENGTH": "268435456",
    "MAX_IMPORT_CONTENT_LENGTH": "536870912",
    ...
    # Optional: comma-separated Google Workspace domains allowed to sign in,
    # or * for any university's Workspace (the default when absent).
